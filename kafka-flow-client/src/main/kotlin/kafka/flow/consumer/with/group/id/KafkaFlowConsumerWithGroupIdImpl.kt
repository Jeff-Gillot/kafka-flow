...
public class KafkaFlowConsumerWithGroupIdImpl(
    ...
    init {
        requireNotNull(clientProperties[ConsumerConfig.GROUP_ID_CONFIG]) { "GROUP_ID_CONFIG must be set" }
    }
    ...
    private fun properties(): Properties {
        if (startOffsetPolicy is StartOffsetPolicy.Earliest) clientProperties[ConsumerConfig.AUTO_OFFSET_RESET_CONFIG] = "earliest"
        if (startOffsetPolicy is StartOffsetPolicy.Latest) clientProperties[ConsumerConfig.AUTO_OFFSET_RESET_CONFIG] = "latest"
